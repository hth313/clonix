...
;;;
;;; This version merges Hepax and non-Hepax variants of NoV-64 functionality
;;; into a single source file. The following #defines can be used to specify
;;; the desired behavior:
;;;
;;; HEPAX  - Hepax functionality. Hardcodes mapping of Hepax and enables
;;;          its relocation behavior.
;;; MLDL   - MLDL behavior, this is basically as Hepax, but without
;;;          Hepax and its relocation support. You get 12 flash pages to play
;;;          with and RAM pages 8-B that can be mapped in and out using the
;;;          control word.
;;;
...
#if !defined(HEPAX) && !defined(MLDL)
#error "define one of HEPAX or MLDL to configure NoV-64"
#endif
...
;        bcf     TRISB,1  hth
        ...
        btfss   locpend,1       ; It has not been a normal start-up
                                ; ENTER-ON or <- ON (Reset mode), disable RAM read
        call    RST_mode
#endif
scndslp
        sleep
