...
;;;
;;; Very Low Power Clonix Double Sized "ClonixLD" Label "Clonix D"
;;;
...
#define NUTPB3  PORTB,1
#define SENSEB3 PORTB,3
...
;  Configuration constants
		...
		.byte	0x02		; -*- Enables HS oscillator mode
		.byte	0x19		; -*- Prevents Brown out Reset
		.byte	0x1e		; -*- Disables Watch Dog Timer (postscale 1:32768)
		.byte	0xff
		.byte	0x81		; -*_ Disables Timer, PORTB is I/O
		.byte	0x80		; -*- Disables Low Voltage Programming
		.byte	0xff


; Define where to map each page
...
CNT1m		.space	1		; 1 mS Delay counter
srtupend	.space	1
...
; Reset vector
		...
		.section reset
rst
		clrf	INTCON  	; Globally disables interrupts.
...
; clear memory
		...
		movlw	0x55
		movwf	srtupend
firstslp	sleep			; Waits until rising edge on PWO (PORTB,0)
...
;; load rom mapping
		...
		bcf	SENSEB3		; Put GND to SENSEB3
		bcf	TRISB,3		; Out GND
		call	DELAY1m
		btfsc	NUTPB3		; If B3 is open GND must be read
		bra	map2		; Otherwise Vcc will be read.
		bsf	TRISB,3		; Set SENSEB3 HiZ
